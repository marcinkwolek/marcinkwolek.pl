...
$(document).ready(function () {
    ...
    var names = ['Marcin Kwolek', 'Junior Front-End Developer', 'IT Student', ' Junior Programmer'];
    var stringToType = '';
    var speed = 200;
...
function mcImgSlider(i) {
    for (var I = function (a) {
            return document.getElementById(a)
             ...
             t = function (e) {
                 ...
                 if (a) for (var b = 0,
                                 f = a[d]; b < f; b++) a[b].nodeType == 1 && c.push(a[b]);
                 return c
    ...
    sb();
    var c = "style", H = "display", Eb = "visibility", r = "width", q = "height", O = "top", B = "background",
        p = "undefined", Fb = "marginLeft", F = "appendChild", l = "parentNode", k = "nodeName", S = "innerHTML",
        cb = "offsetWidth", u = setTimeout, z = clearTimeout, w = "indexOf", N = "setAttribute", bb = "removeChild",
        L = function () {
            this.d = [];
            this.b = null
        }, zb = function () {
            ...
            return b
        }, T = zb() < 9, ab = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),
        K = function (a, b) {
            if (a) {
                a.o = b;
                if (T) a[c].filter = "alpha(opacity=" + b * 100 + ")"; else a[c][y] = b
            }
        };
    L.a = {
        f: function (a) {
    ...
    L.prototype = {
        k: {
            ...
            if (a) {
                ...
                if (J && W) W(this.b); else window.clearInterval(this.b);
                this.b = null
            }
        }, o: function (a) {
            if (a.d.e < a.d[d]) {
    ...
    var G = new L, gb = function () {
            ...
            return a.join("")
        }, b = {a: 0, e: "", d: 0, c: 0, b: 0}, a, f, o, s, D, A, m, R, x, M, X, e, E, j = null, vb = function () {
    ...
    lb.prototype = {
        c: function () {
            ...
            while (G--) {
                ...
                if (j[k] == "A" && j[g][w]("lazyImage") == -1) if (j[g]) j[g] = "imgLink " + j[g]; else j[g] = "imgLink";
                if (n) e.push(n); else e.push(j);
                if (j[g][w](" video") != -1) {
                    this.A(j);
                    this.b(j)
                }
            ...
            var v = this.v();
            if (e[b.a][k] == "IMG") b.e = e[b.a]; else b.e = U(e[b.a], "img")[0];
            ...
            for (var e = [], a = 0; a < b.d; a++) e.push("<div rel=''></div>");
            x[S] = e.join("");
            ...
            if (a[k] != "IMG") {
                if (a[k] == "A") var d = a[h]("href"), f = a[h]("title") || "",
                    i = 1; else if (a[k] == "VIDEO" || a[k] == "AUDIO") {
                    var n = 1;
                    d = a[h]("data-image");
                    if (d) f = a[h]("data-alt") || "";
            ...
            if (c < 9) this.q(d, c); else if (c < 13) this.r(d, c); else if (c == 13) this.s(d); else if (c < 16) this.t(d, c); else this.u(d, c)
        }, q: function (b, e) {
            for (var f = 0, g = e < 7 ? {height: 0, opacity: -.4} : {width: 0, opacity: 0}, i = {
                height: s,
                opacity: 1
            }, a = 0, h = b[d]; a < h; a++) {
                if (e < 3) b[a][c].bottom = "0"; else if (e < 5) b[a][c][O] = "0"; else if (e < 7) {
            ...
            if (b < 11) var e = 0, f = o; else {
                e = 0;
                f = s
            }
            var g = {
                b: L.a.j, c: a.c * 1.6, a: function () {
                    j.o()
                }
            };
            ...
            for (var k = [], i = g > 8 ? o : Math.round(o / a.f), l = g > 8 ? 1 : a.f, f = 0; f < l; f++) {
                ...
                if (g == 10) e[B] = 'url("' + b.e[h]("src") + '") no-repeat right top'; else if (g == 12) e[B] = 'url("' + b.e[h]("src") + '") no-repeat left bottom';
                e.position = "absolute";
                K(j, 0);
                E[F](j);
                k[k[d]] = j
            ...
            var f = b.a;
            b.a = this.n(a);
            if (k || !i.m) f = 0; else f = f > b.a ? "10" : "9";
            this.p(f)
        }, n: function (a) {
    ...
    var Z = function () {
        var a = I(i.sliderId);
        if (a && t(a)[d] && a.offsetHeight) j = new lb(a); else u(Z, 500)
    };
    Y();
    var Ab = function (c) {
        var a = false;
    ...
    var Db = function () {
        ...
        if (++mb < 20) if (!j || typeof tooltip == p) u(function () {
            fb(e, c)
        }, 300); else for (var b = t(x), a = 0; a < b[d]; a++) b[a].onmouseover = function () {
